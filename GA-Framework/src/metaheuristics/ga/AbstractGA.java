...
public abstract class AbstractGA<G extends Number, F> {
	...
	/**
	 * The crossover step takes the parents generated by {@link #selectParents}
	 * and recombine their genes to generate new chromosomes (offsprings). Uniform crossover
	 * is done based on a randomly generated binary crossover mask. If the bit on the crossover mask
	 * is equals 1 the chromosome is taken from parent P1, if it's equals 0 then the chromosome
	 * is taken from parent P2. For example:
	 * 
	 *                        P1            P2
	 *    Parent 1: X1 ... Xi | Xi+1 ... Xj | Xj+1 ... Xn
	 *    Parent 2: Y1 ... Yi | Yi+1 ... Yj | Yj+1 ... Yn
	 *    Mask:     0  ... 1  | 1    ... 0  | 0    ... 0
	 * 
	 * Offspring 1: Y1 ... Xi | Xi+1 ... Yj | Yj+1 ... Yn
	 * Offspring 2: Y1 ... Xi | Xi+1 ... Xj | Yj+1 ... Yn
	 * 
	 * @param parents
	 *            The selected parents for crossover.
	 * @return The resulting offsprings.
	...
	protected Population uniformCrossover(Population parents) {
		...
		int[] crosspoint = new int[popSize];
